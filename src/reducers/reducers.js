import pageInfo from '../components/ContentPage/pageInfo'
...
export const navReducer = (
  state = { navLocation: 'The Field Guide', hoverItem: '', visible: false },
  action
) => {
  switch (action.type) {
    case 'SET_HOVER_ITEM':
...
export const pageInfoReducer = (state = pageInfo, action) => {
  // eslint-disable-line
  return state
}
